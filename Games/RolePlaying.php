...
<?php  
    include "conn.php";
	$sql = "SELECT * FROM `gamecoll` WHERE `Genere` LIKE '%Role Playing%' ORDER BY `Id` DESC limit $s_point , $v_onpage";
	...
	echo "</table>";
		$sql = "SELECT * FROM `gamecoll` WHERE `Genere` LIKE '%Role Playing%'";  
	$cat = "RolePlaying";
?>
<br>
<br>
